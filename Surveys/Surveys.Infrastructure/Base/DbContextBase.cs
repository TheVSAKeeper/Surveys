...
public abstract class DbContextBase(DbContextOptions options) : IdentityDbContext<ApplicationUser, ApplicationRole, Guid>(options)
{
    ...
    private const string CreatedAt = nameof(IAuditable.CreatedAt);
    private const string CreatedBy = nameof(IAuditable.CreatedBy);
    private const string UpdatedAt = nameof(IAuditable.UpdatedAt);
    private const string UpdatedBy = nameof(IAuditable.UpdatedBy);
