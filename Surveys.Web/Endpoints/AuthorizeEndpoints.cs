...
public sealed class AuthorizeEndpoints : AppDefinition
{
        ...
        IOpenIddictAuthorizationManager authorizationManager)
    {
        ...
        var authorizations = await authorizationManager.FindAsync(subject: userId,
                client: applicationId!,
                status: OpenIddictConstants.Statuses.Valid,
                type: OpenIddictConstants.AuthorizationTypes.Permanent,
                scopes: iddictRequest.GetScopes())
            .ToListAsync();
        ...
        switch (await applicationManager.GetConsentTypeAsync(application))
        {
            ...
            case OpenIddictConstants.ConsentTypes.External when !authorizations.Any():
                return Microsoft.AspNetCore.Http.Results.Forbid(authenticationSchemes: new[] { OpenIddictServerAspNetCoreDefaults.AuthenticationScheme },
            ...
            case OpenIddictConstants.ConsentTypes.Explicit when authorizations.Any() && !iddictRequest.HasPrompt(OpenIddictConstants.Prompts.Consent):
                ...
                var authorization = authorizations.LastOrDefault()
                                    ?? await authorizationManager.CreateAsync(principal: principal,
            ...
            default:
                return Microsoft.AspNetCore.Http.Results.Challenge(authenticationSchemes: new[] { OpenIddictServerAspNetCoreDefaults.AuthenticationScheme },
